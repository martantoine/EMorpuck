...
/*
 * How is this function fucking averaging the center ?
 * An offset is missing, and the name is misleading
 * Something like averageChannelOnCenter()
 */
uint8_t mean_center(uint8_t *buffer) {
    uint32_t mean = 0;
...
static THD_FUNCTION(ProcessImage, arg) {
    ...
    for(;;) {
        ...
        // WHAT the FUCK is j declared for ??
        uint16_t j = 0;
